...
server_chan_url = "https://sc.ftqq.com/SCT46241T8ssGJzWezcuVaXDl8UCBcc3m.send"

# 多台示例,MAC需要全部大写如 AABBCCDDEE11
jd_router_device_list = [
     {"router_name": "00", "router_mac": "DCD87C201D2E"},
     {"router_name": "01", "router_mac": "DCD87C0D23F7"}
]

# x-app-id 固定996
headers = {
    "wskey": "AAJgntkBAEACVdroKe5ylAB6TcBz1TaKgnNJ5F348Q2wPHuA4inwmco9E4wNrovbHfli5gEeILsxoQxygxB_4Wsk5wWVIkDS",
    "x-app-id": "996",
...
def get_point():
    ...
    for device in jd_router_device_list:
        ...
        params = {"mac": router_mac, "source": "1", "currentPage": 1, "pageSize": 14}
